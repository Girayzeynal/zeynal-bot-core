...
FAZ22 and FAZ23) to deliver pre-match analysis, market enrichment, Monte Carlo
simulations, risk calibration and snapshot persistence.
"""
...
async def cmd_analyze(update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # 4) Score & finalize via FAZ-22
    core = faz22.score_and_finalize(core)

    # 5) Persist snapshot via FAZ-23
