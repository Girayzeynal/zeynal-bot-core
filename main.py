...
def init(self, balldontlie_api_key: str, api_sports_key: str):
...
def init(self, odds_api_key: str):
...
band_str = (f"Home by 1: {home1100/iterations:.1f}%, "
f"Home by 2+: {homeb100/iterations:.1f}%, "
f"Draw: {draw100/iterations:.1f}%, "
f"Away by 1: {away1100/iterations:.1f}%, "
f"Away by 2+: {awayb100/iterations:.1f}%")
else:
...
away1 = simulation["margin_counts"]["away_1"]
awayb = simulation["margin_counts"]["away_big"]
band_str = (f"Home by 1-5: {home1100/iterations:.1f}%, "
f"Home by 6+: {homeb100/iterations:.1f}%, "
f"Away by 1-5: {away1100/iterations:.1f}%, "
